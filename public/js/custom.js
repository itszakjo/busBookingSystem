    ...
    // 2. range js
        ...
        $( "#slider-range" ).slider({
            ...
            slide: function( event, ui ) {
                ...
                $("#firstRange").val(ui.values[ 0 ]);
                $("#secondRange").val(ui.values[ 1 ]);
            }
        });
        $("#firstRange").val($( "#slider-range" ).slider( "values", 0 ));
        $("#secondRange").val($( "#slider-range" ).slider( "values", 1 ));
        // $( "#amount" ).val( "SAR" + $( "#slider-range" ).slider( "values", 0 ) +" - SAR" + $( "#slider-range" ).slider( "values", 1 ) );
        $( "#amount" ).html( "SAR " + $( "#slider-range" ).slider( "values", 0 ) +" - SAR " + $( "#slider-range" ).slider( "values", 1 ) );
