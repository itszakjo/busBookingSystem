...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900" >
            ...
            <div class="col-md-8" style="margin-top: 55px" >
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                   <h1>  Book <?php echo e($trip->name); ?> </h1>
                </div>
                ...
                <div class="seatSelection col-lg-12">
                    ...
                    <div class=" col-lg-3">
                        <form class="form-horizontal" action="<?php echo e(route('booking.store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>

                            <!-- hidden Fields -->
                            <input hidden type="text" class="form-control trip_id" name="trip" placeholder="ID" value="<?php echo e($trip->id); ?>" required  >
                            <input hidden type="text" class="form-control seat_price" name="seat_price" placeholder="Seat Price" value="<?php echo e($trip->seat_price); ?>" required  >
                            ...
                            <div class="form-group">
                                <select class="form-control pickup_point_select " name="pickup_point" required>
                                    ...
                                    <?php $__currentLoopData = $stop_points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option class="form-control" value="<?php echo e($row->id); ?>" ><?php echo e($row->station->name); ?></option>
    ...
    <script>
        ...
        $("body").on("change", ".pickup_point_select", function () {
            ...
            $.ajax({
                url: "<?php echo e(route('seats.show')); ?>",
                method: "POST",
                data: {
...
<?php /**PATH D:\Laravel pros\busBookingSystem\resources\views/web/book_trip.blade.php ENDPATH**/ ?>